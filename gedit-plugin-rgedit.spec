...
install -d $RPM_BUILD_ROOT{%{_libdir},%{_datadir}}/gedit/plugins

cp -a RCtrl.py $RPM_BUILD_ROOT%{_libdir}/gedit/plugins/
cp -a RCtrl.gedit-plugin $RPM_BUILD_ROOT%{_libdir}/gedit/plugins/
cp -a RCtrl $RPM_BUILD_ROOT%{_datadir}/gedit/plugins/
...
%doc ReadMe.txt
%{_libdir}/gedit/plugins/RCtrl.py
%{_libdir}/gedit/plugins/RCtrl.gedit-plugin
%{_datadir}/gedit/plugins/RCtrl
